# PyGreece Community Οργανωτική Δομή & Κανόνες
...
Παρακάτω μπορείτε να βρείτε τους κανόνες της Κοινότητας PyGreece, της Ελληνικής Κοινότητας Python που διαχειρίζεται η PyGreece ΑΜΚΕ. Το καταστατικό του PyGreece AMKE είναι διαφορετικό και μπορείτε να το βρείτε εδώ (TODO: Link to the doc).
...
5. Η συμμετοχή είναι ανοιχτή σε άτομα που επιθυμούν να συμμετάσχουν ενεργά στην υλοποίηση της αποστολής της Κοινότητας PyGreece.
