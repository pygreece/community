...
- Το PyGreece ΑΜΚΕ μία Αστική Μη Κερδοσκοπική Εταιρεία που δημιουργήθηκε από μέλη της
...
- Για να γίνει μέλος, ο αιτών πρέπει να στείλει ένα μήνυμα στο διοικητικό συμβούλιο του
...
- Το διοικητικό συμβούλιο είναι υπεύθυνο να επιλέξει έναν ανεξάρτητο υπεύθυνο και τη μορφή
  της ΓΣ με τη συμφωνία του αιτούντος.

- Το διοικητικό συμβούλιο χειρίζεται όλες τις καθημερινές εργασίες της PyGreece ΑΜΚΕ.
...
- Μέλος που ενεργεί κατά των συμφερόντων της κοινότητας PyGreece ή του PyGreece ΑΜΚΕ
  ...
  περίπτωση που το μέλος αυτό είναι μέλος του διοικητικού συμβουλίου, αποκλείεται από την
  ψηφοφορία και η απόφαση χρειάζεται την πλήρη πλειοψηφία των υπόλοιπων μελών του
  διοικητικού συμβουλίου. Ένα μέλος μπορεί να διαγραφεί και από τη Γενική Συνέλευση της
  κοινότητας PyGreece, σε συνεδρίαση της Συνέλευσης με τακτική ψηφοφορία με απλή
  πλειοψηφία.

- Σε περίπτωση διάλυσης, τα περιουσιακά στοιχεία της PyGreece ΑΜΚΕ περιέρχονται σε ΜΚΟ που
  ψηφίστηκε από τη Γενική Συνέλευση της κοινότητας PyGreece.

- Οποιαδήποτε πρόταση τροποποίησης των κανόνων του PyGreece Community πρέπει να υποβληθεί
  ...
  πρότασης παραμένει αμετάβλητη. Η πρόταση αλλαγής των κανόνων πρέπει να υποστηρίζεται από
  τουλάχιστον δύο τρίτα των παρόντων ψηφοφόρων/εκπροσώπων για να ψηφιστεί.
